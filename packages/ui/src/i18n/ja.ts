export const dict = {
  ...
  "ui.sessionReview.expandAll": "すべて展�?,
  ...
  "ui.lineComment.placeholder": "コメントを追�?,
  "ui.lineComment.submit": "コメント",
  "ui.sessionTurn.steps.show": "ステップを表�?,
  "ui.sessionTurn.steps.hide": "ステップを隠�?,
  ...
  "ui.sessionTurn.status.searchingWeb": "ウェブを検索�?,
  ...
  "ui.messagePart.diagnostic.error": "エラ�?,
  "ui.messagePart.title.edit": "編集",
  "ui.messagePart.title.write": "作成",
  "ui.messagePart.option.typeOwnAnswer": "自分の回答を入力",
  "ui.messagePart.review.title": "回答を確�?,

  "ui.list.loading": "読み込み�?,
  "ui.list.empty": "結果なし",
  "ui.list.clearFilter": "フィルターをクリ�?,
  "ui.list.emptyWithFilter.prefix": "次の検索結果はありません: ",
  "ui.list.emptyWithFilter.suffix": "",

  "ui.messageNav.newMessage": "新しいメッセージ",

  "ui.textField.copyToClipboard": "クリップボードにコピ�?,
  "ui.textField.copyLink": "リンクをコピ�?,
  "ui.textField.copied": "コピーしまし�?,

  "ui.imagePreview.alt": "画像プレビュ�?,
  ...
  "ui.common.add": "追加",
  "ui.common.cancel": "キャンセ�?,
  "ui.common.confirm": "確認",
  "ui.common.dismiss": "閉じ�?,
  "ui.common.close": "閉じ�?,
  "ui.common.next": "次へ",
  "ui.common.submit": "送信",
  ...
  "ui.patch.action.patched": "パッチ適用済�?,

  "ui.question.subtitle.answered": "{{count}}件回答済�?,
  "ui.question.answer.none": "(回答なし)",
  "ui.question.review.notAnswered": "(未回�?",
  "ui.question.multiHint": "(該当するものをすべて選択)",
  "ui.question.custom.placeholder": "回答を入�?..",
}
