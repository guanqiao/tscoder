...
export const dict = {
  ...
  "ui.sessionReview.title.lastTurn": "上一輪變�?,
  ...
  "ui.sessionReview.change.added": "已新�?,
  ...
  "ui.sessionTurn.status.thinkingWithTopic": "思�?- {{topic}}",
  "ui.sessionTurn.status.gatheringThoughts": "正在整理思緒",
  "ui.sessionTurn.status.consideringNextSteps": "正在考慮下一�?,

  "ui.messagePart.diagnostic.error": "錯誤",
  "ui.messagePart.title.edit": "編輯",
  "ui.messagePart.title.write": "寫入",
  "ui.messagePart.option.typeOwnAnswer": "輸入自己的答�?,
  ...
  "ui.list.emptyWithFilter.suffix": "的結�?,

  "ui.messageNav.newMessage": "新訊�?,

  "ui.textField.copyToClipboard": "複製到剪貼簿",
  "ui.textField.copyLink": "複製連結",
  "ui.textField.copied": "已複�?,
  ...
  "ui.tool.patch": "修補",
  "ui.tool.todos": "待辦",
  "ui.tool.todos.read": "讀取待�?,
  "ui.tool.questions": "問題",
  "ui.tool.agent": "{{type}} 代理程式",

  "ui.common.file.one": "個檔�?,
  "ui.common.file.other": "個檔�?,
  "ui.common.question.one": "個問�?,
  "ui.common.question.other": "個問�?,
  ...
  "ui.permission.allowOnce": "允許一�?,

  "ui.message.expand": "展開訊息",
  "ui.message.collapse": "收合訊息",
  "ui.message.copy": "複製",
  "ui.message.copied": "已複�?,
  "ui.message.attachment.alt": "附件",

  "ui.patch.action.deleted": "已刪�?,
  "ui.patch.action.created": "已建�?,
  "ui.patch.action.moved": "已移�?,
  "ui.patch.action.patched": "已套用修�?,

  "ui.question.subtitle.answered": "{{count}} 已回�?,
  "ui.question.answer.none": "(無答�?",
