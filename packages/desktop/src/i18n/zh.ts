export const dict = {
  ...
  "desktop.updater.downloaded.title": "更新已下�?,
  "desktop.updater.downloaded.prompt": "已下�?OpenCode {{version}} 版本，是否安装并重启�?,
  "desktop.updater.installFailed.title": "更新失败",
  "desktop.updater.installFailed.message": "无法安装更新",

  "desktop.cli.installed.title": "CLI 已安�?,
