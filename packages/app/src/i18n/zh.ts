...
export const dict = {
  ...
  "command.sidebar.toggle": "切换侧边�?,
  "command.project.open": "打开项目",
  "command.provider.connect": "连接提供�?,
  "command.server.switch": "切换服务�?,
  "command.settings.open": "打开设置",
  "command.session.previous": "上一个会�?,
  "command.session.next": "下一个会�?,
  "command.session.previous.unseen": "上一个未读会�?,
  "command.session.next.unseen": "下一个未读会�?,
  ...
  "command.tab.close": "关闭标签�?,
  "command.context.addSelection": "将所选内容添加到上下�?,
  "command.context.addSelection.description": "添加当前文件中选中的行",
  "command.input.focus": "聚焦输入�?,
  "command.terminal.toggle": "切换终端",
  "command.fileTree.toggle": "切换文件�?,
  "command.review.toggle": "切换审查",
  "command.terminal.new": "新建终端",
  "command.terminal.new.description": "创建新的终端标签�?,
  "command.steps.toggle": "切换步骤",
  "command.steps.toggle.description": "显示或隐藏当前消息的步骤",
  "command.message.previous": "上一条消�?,
  "command.message.previous.description": "跳转到上一条用户消�?,
  "command.message.next": "下一条消�?,
  "command.message.next.description": "跳转到下一条用户消�?,
  "command.model.choose": "选择模型",
  "command.model.choose.description": "选择不同的模�?,
  "command.mcp.toggle": "切换 MCPs",
  "command.mcp.toggle.description": "切换 MCPs",
  "command.agent.cycle": "切换智能�?,
  "command.agent.cycle.description": "切换到下一个智能体",
  "command.agent.cycle.reverse": "反向切换智能�?,
  "command.agent.cycle.reverse.description": "切换到上一个智能体",
  "command.model.variant.cycle": "切换思考强�?,
  "command.model.variant.cycle.description": "切换到下一个强度等�?,
  "command.permissions.autoaccept.enable": "自动接受编辑",
  "command.permissions.autoaccept.disable": "停止自动接受编辑",
  "command.workspace.toggle": "切换工作�?,
  "command.session.undo": "撤销",
  "command.session.undo.description": "撤销上一条消�?,
  "command.session.redo": "重做",
  "command.session.redo.description": "重做上一条撤销的消�?,
  "command.session.compact": "精简会话",
  "command.session.compact.description": "总结会话以减少上下文大小",
  "command.session.fork": "从消息分�?,
  "command.session.fork.description": "从之前的消息创建新会�?,
  "command.session.share": "分享会话",
  "command.session.share.description": "分享此会话并将链接复制到剪贴�?,
  "command.session.unshare": "取消分享会话",
  "command.session.unshare.description": "停止分享此会�?,
  ...
  "dialog.provider.search.placeholder": "搜索提供�?,
  "dialog.provider.empty": "未找到提供商",
  "dialog.provider.group.popular": "热门",
  "dialog.provider.group.other": "其他",
  "dialog.provider.tag.recommended": "推荐",
  "dialog.provider.anthropic.note": "使用 Claude Pro/Max �?API 密钥连接",
  "dialog.provider.openai.note": "使用 ChatGPT Pro/Plus �?API 密钥连接",
  "dialog.provider.copilot.note": "使用 Copilot �?API 密钥连接",
  "dialog.provider.opencode.note": "使用 OpenCode Zen �?API 密钥连接",
  "dialog.provider.google.note": "使用 Google 账号�?API 密钥连接",
  "dialog.provider.openrouter.note": "使用 OpenRouter 账号�?API 密钥连接",
  "dialog.provider.vercel.note": "使用 Vercel 账号�?API 密钥连接",

  "dialog.model.select.title": "选择模型",
  "dialog.model.search.placeholder": "搜索模型",
  "dialog.model.empty": "未找到模�?,
  "dialog.model.manage": "管理模型",
  "dialog.model.manage.description": "自定义模型选择器中显示的模型�?,

  "dialog.model.unpaid.freeModels.title": "OpenCode 提供的免费模�?,
  "dialog.model.unpaid.addMore.title": "从热门提供商添加更多模型",

  "dialog.provider.viewAll": "查看更多提供�?,
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 OpenCode 中使�?{{provider}} 模型�?,
  ...
  "provider.connect.opencodeZen.line2": "只需一�?API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型�?,
  ...
  "provider.connect.oauth.code.visit.link": "此链�?,
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并�?OpenCode 中使�?{{provider}} 模型�?,
  "provider.connect.oauth.code.label": "{{method}} 授权�?,
  "provider.connect.oauth.code.placeholder": "授权�?,
  "provider.connect.oauth.code.required": "授权码为必填�?,
  "provider.connect.oauth.code.invalid": "授权码无�?,
  "provider.connect.oauth.auto.visit.prefix": "访问 ",
  "provider.connect.oauth.auto.visit.link": "此链�?,
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并�?OpenCode 中使�?{{provider}} 模型�?,
  "provider.connect.oauth.auto.confirmationCode": "确认�?,
  "provider.connect.toast.connected.title": "{{provider}} 已连�?,
  "provider.connect.toast.connected.description": "现在可以使用 {{provider}} 模型了�?,

  "provider.custom.title": "自定义提供商",
  "provider.custom.description.prefix": "配置�?OpenAI 兼容的提供商。请查看",
  "provider.custom.description.link": "提供商配置文�?,
  ...
  "provider.custom.headers.key.label": "请求�?,
  "provider.custom.headers.key.placeholder": "Header-Name",
  "provider.custom.headers.value.label": "�?,
  "provider.custom.headers.value.placeholder": "value",
  "provider.custom.headers.remove": "移除请求�?,
  "provider.custom.headers.add": "添加请求�?,
  "provider.custom.error.providerID.required": "提供�?ID 为必填项",
  "provider.custom.error.providerID.format": "请使用小写字母、数字、连字符或下划线",
  "provider.custom.error.providerID.exists": "该提供商 ID 已存�?,
  "provider.custom.error.name.required": "显示名称为必填项",
  "provider.custom.error.baseURL.required": "基础 URL 为必填项",
  "provider.custom.error.baseURL.format": "必须�?http:// �?https:// 开�?,
  ...
  "model.tooltip.reasoning.none": "不支持推�?,
  "model.tooltip.context": "上下文上�?{{limit}}",
  ...
  "prompt.placeholder.normal": '随便问点什�?.. "{{example}}"',
  "prompt.placeholder.summarizeComments": "总结评论�?,
  "prompt.placeholder.summarizeComment": "总结该评论�?,
  "prompt.mode.shell": "Shell",
  "prompt.mode.shell.exit": "�?esc 退�?,

  "prompt.example.1": "修复代码库中的一�?TODO",
  "prompt.example.2": "这个项目的技术栈是什么？",
  "prompt.example.3": "修复失败的测�?,
  "prompt.example.4": "解释认证是如何工作的",
  "prompt.example.5": "查找并修复安全漏�?,
  "prompt.example.6": "为用户服务添加单元测�?,
  "prompt.example.7": "重构这个函数，让它更易读",
  "prompt.example.8": "这个错误是什么意思？",
  "prompt.example.9": "帮我调试这个问题",
  "prompt.example.10": "生成 API 文档",
  "prompt.example.11": "优化数据库查�?,
  "prompt.example.12": "添加输入校验",
  "prompt.example.13": "创建一个新的组件用�?..",
  "prompt.example.14": "我该如何部署这个项目�?,
  "prompt.example.15": "审查我的代码并给出最佳实践建�?,
  "prompt.example.16": "为这个函数添加错误处�?,
  "prompt.example.17": "解释这个正则表达�?,
  "prompt.example.18": "把它转换�?TypeScript",
  "prompt.example.19": "在整个代码库中添加日�?,
  "prompt.example.20": "哪些依赖已经过期�?,
  "prompt.example.21": "帮我写一个迁移脚�?,
  "prompt.example.22": "为这个接口实现缓�?,
  "prompt.example.23": "给这个列表添加分�?,
  "prompt.example.24": "创建一�?CLI 命令用于...",
  "prompt.example.25": "这里的环境变量是怎么工作的？",

  "prompt.popover.emptyResults": "没有匹配的结�?,
  "prompt.popover.emptyCommands": "没有匹配的命�?,
  "prompt.dropzone.label": "将图片或 PDF 拖到这里",
  "prompt.dropzone.file.label": "拖放�?@提及文件",
  "prompt.slash.badge.custom": "自定�?,
  "prompt.slash.badge.skill": "技�?,
  ...
  "prompt.action.send": "发�?,
  "prompt.action.stop": "停止",

  "prompt.toast.pasteUnsupported.title": "不支持的粘贴",
  "prompt.toast.pasteUnsupported.description": "这里只能粘贴图片�?PDF 文件�?,
  "prompt.toast.modelAgentRequired.title": "请选择智能体和模型",
  "prompt.toast.modelAgentRequired.description": "发送提示前请先选择智能体和模型�?,
  "prompt.toast.worktreeCreateFailed.title": "创建工作树失�?,
  "prompt.toast.sessionCreateFailed.title": "创建会话失败",
  "prompt.toast.shellSendFailed.title": "发�?shell 命令失败",
  "prompt.toast.commandSendFailed.title": "发送命令失�?,
  "prompt.toast.promptSendFailed.title": "发送提示失�?,
  "prompt.toast.promptSendFailed.description": "无法获取会话",

  "dialog.mcp.title": "MCPs",
  "dialog.mcp.description": "已启�?{{enabled}} / {{total}}",
  "dialog.mcp.empty": "未配�?MCPs",

  "dialog.lsp.empty": "已从文件类型自动检测到 LSPs",
  "dialog.plugins.empty": "�?opencode.json 中配置的插件",

  "mcp.status.connected": "已连�?,
  "mcp.status.failed": "失败",
  "mcp.status.needs_auth": "需要授�?,
  "mcp.status.disabled": "已禁�?,

  "dialog.fork.empty": "没有可用于分叉的消息",

  "dialog.directory.search.placeholder": "搜索文件�?,
  "dialog.directory.empty": "未找到文件夹",

  "dialog.server.title": "服务�?,
  ...
  "dialog.project.edit.icon.hint": "点击或拖拽图�?,
  "dialog.project.edit.icon.recommended": "建议�?28x128px",
  "dialog.project.edit.color": "颜色",
  "dialog.project.edit.color.select": "选择{{color}}颜色",

  "dialog.project.edit.worktree.startup": "工作区启动脚�?,
  ...
  "context.systemPrompt.title": "系统提示�?,
  "context.rawMessages.title": "原始消息",

  "context.stats.session": "会话",
  "context.stats.messages": "消息�?,
  "context.stats.provider": "提供�?,
  "context.stats.model": "模型",
  "context.stats.limit": "上下文限�?,
  "context.stats.totalTokens": "�?token",
  ...
  "context.stats.totalCost": "总成�?,
  "context.stats.sessionCreated": "创建时间",
  "context.stats.lastActivity": "最后活�?,

  "context.usage.tokens": "Token",
  "context.usage.usage": "使用�?,
  "context.usage.cost": "成本",
  "context.usage.clickToView": "点击查看上下�?,
  "context.usage.view": "查看上下文用�?,

  "toast.language.title": "语言",
  "toast.language.description": "已切换到{{language}}",

  "toast.theme.title": "主题已切�?,
  ...
  "toast.permissions.autoaccept.off.title": "已停止自动接受编�?,
  "toast.permissions.autoaccept.off.description": "编辑和写入权限将需要手动批�?,

  "toast.model.none.title": "未选择模型",
  "toast.model.none.description": "请先连接提供商以总结此会�?,

  "toast.file.loadFailed.title": "加载文件失败",

  "toast.file.listFailed.title": "列出文件失败",
  "toast.context.noLineSelection.title": "未选择�?,
  "toast.context.noLineSelection.description": "请先在文件标签中选择行范围�?,
  "toast.session.share.copyFailed.title": "无法复制链接到剪贴板",
  "toast.session.share.success.title": "会话已分�?,
  "toast.session.share.success.description": "分享链接已复制到剪贴�?,
  "toast.session.share.failed.title": "分享会话失败",
  "toast.session.share.failed.description": "分享会话时发生错�?,

  "toast.session.unshare.success.title": "已取消分享会�?,
  "toast.session.unshare.success.description": "会话已成功取消分�?,
  "toast.session.unshare.failed.title": "取消分享失败",
  "toast.session.unshare.failed.description": "取消分享会话时发生错�?,

  "toast.session.listFailed.title": "无法加载 {{project}} 的会�?,

  "toast.update.title": "有可用更�?,
  "toast.update.description": "OpenCode 有新版本 ({{version}}) 可安装�?,
  "toast.update.action.installRestart": "安装并重�?,
  "toast.update.action.notYet": "稍后",

  "error.page.title": "出了点问�?,
  ...
  "error.page.action.checkUpdates": "检查更�?,
  "error.page.action.updateTo": "更新�?{{version}}",
  "error.page.report.prefix": "请将此错误报告给 OpenCode 团队",
  "error.page.report.discord": "�?Discord �?,
  "error.page.version": "版本：{{version}}",

  "error.dev.rootNotFound": "未找到根元素。你是不是忘了把它添加到 index.html？或�?id 属性拼写错了？",

  "error.globalSync.connectFailed": "无法连接到服务器。是否有服务器正�?`{{url}}` 运行�?,
  ...
  "error.chain.checkConfig": "请检查你的配�?(opencode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务�?"{{name}}" 启动失败。注�? OpenCode 暂不支持 MCP 认证�?,
  "error.chain.providerAuthFailed": "提供商认证失败（{{provider}}）：{{message}}",
  "error.chain.providerInitFailed": '无法初始化提供商 "{{provider}}"。请检查凭据和配置�?,
  "error.chain.configJsonInvalid": "配置文件 {{path}} 不是有效�?JSON(C)",
  "error.chain.configJsonInvalidWithMessage": "配置文件 {{path}} 不是有效�?JSON(C)：{{message}}",
  "error.chain.configDirectoryTypo":
    '{{path}} 中的目录 "{{dir}}" 无效。请将目录重命名�?"{{suggestion}}" 或移除它。这是一个常见拼写错误�?,
  ...
  "notification.permission.title": "需要权�?,
  "notification.permission.description": "{{sessionTitle}}（{{projectName}}）需要权�?,
  "notification.question.title": "问题",
  "notification.question.description": "{{sessionTitle}}（{{projectName}}）有一个问�?,
  "notification.action.goToSession": "前往会话",

  "notification.session.responseReady.title": "回复已就�?,
  "notification.session.error.title": "会话错误",
  "notification.session.error.fallbackDescription": "发生错误",

  "home.recentProjects": "最近项�?,
  "home.empty.title": "没有最近项�?,
  "home.empty.description": "通过打开本地项目开始使�?,

  "session.tab.session": "会话",
  "session.tab.review": "审查",
  "session.tab.context": "上下�?,
  "session.panel.reviewAndFiles": "审查和文�?,
  "session.review.filesChanged": "{{count}} 个文件变�?,
  "session.review.change.one": "更改",
  "session.review.change.other": "更改",
  "session.review.loadingChanges": "正在加载更改...",
  "session.review.empty": "此会话暂无更�?,
  "session.review.noChanges": "无更�?,
  "session.files.selectToOpen": "选择要打开的文�?,
  "session.files.all": "所有文�?,
  "session.files.binaryContent": "二进制文件（无法显示内容�?,
  "session.messages.renderEarlier": "显示更早的消�?,
  "session.messages.loadingEarlier": "正在加载更早的消�?..",
  "session.messages.loadEarlier": "加载更早的消�?,
  "session.messages.loading": "正在加载消息...",

  "session.messages.jumpToLatest": "跳转到最�?,
  "session.context.addToContext": "�?{{selection}} 添加到上下文",

  "session.new.worktree.main": "主分�?,
  "session.new.worktree.mainWithBranch": "主分支（{{branch}}�?,
  "session.new.worktree.create": "创建新的 worktree",
  "session.new.lastModified": "最后修�?,

  "session.header.search.placeholder": "搜索 {{project}}",
  "session.header.searchFiles": "搜索文件",

  "status.popover.trigger": "状�?,
  "status.popover.ariaLabel": "服务器配�?,
  "status.popover.tab.servers": "服务�?,
  "status.popover.tab.mcp": "MCP",
  "status.popover.tab.lsp": "LSP",
  "status.popover.tab.plugins": "插件",
  "status.popover.action.manageServers": "管理服务�?,

  "session.share.popover.title": "发布到网�?,
  ...
  "session.share.copy.copied": "已复�?,
  "session.share.copy.copyLink": "复制链接",

  "lsp.tooltip.none": "没有 LSP 服务�?,
  ...
  "terminal.connectionLost.title": "连接已丢�?,
  ...
  "sidebar.nav.projectsAndSessions": "项目和会�?,
  "sidebar.settings": "设置",
  "sidebar.help": "帮助",
  "sidebar.workspaces.enable": "启用工作�?,
  "sidebar.workspaces.disable": "禁用工作�?,
  "sidebar.gettingStarted.title": "入门",
  "sidebar.gettingStarted.line1": "OpenCode 提供免费模型，你可以立即开始使用�?,
  "sidebar.gettingStarted.line2": "连接任意提供商即可使用更多模型，�?Claude、GPT、Gemini 等�?,
  "sidebar.project.recentSessions": "最近会�?,
  ...
  "settings.general.row.appearance.description": "自定�?OpenCode 在你的设备上的外�?,
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定�?OpenCode 的主题�?,
  "settings.general.row.font.title": "字体",
  "settings.general.row.font.description": "自定义代码块使用的等宽字�?,
  "settings.general.row.releaseNotes.title": "发行说明",
  "settings.general.row.releaseNotes.description": "更新后显示“新功能”弹�?,

  "settings.updates.row.startup.title": "启动时检查更�?,
  "settings.updates.row.startup.description": "�?OpenCode 启动时自动检查更�?,
  "settings.updates.row.check.title": "检查更�?,
  "settings.updates.row.check.description": "手动检查更新并在有更新时安�?,
  "settings.updates.action.checkNow": "立即检�?,
  "settings.updates.action.checking": "正在检�?..",
  "settings.updates.toast.latest.title": "已是最新版�?,
  ...
  "settings.general.notifications.agent.title": "智能�?,
  ...
  "settings.general.sounds.agent.title": "智能�?,
  ...
  "settings.general.sounds.errors.description": "发生错误时播放声�?,

  "settings.shortcuts.title": "键盘快捷�?,
  "settings.shortcuts.reset.button": "重置为默认�?,
  "settings.shortcuts.reset.toast.title": "快捷键已重置",
  "settings.shortcuts.reset.toast.description": "键盘快捷键已重置为默认设置�?,
  "settings.shortcuts.conflict.title": "快捷键已被占�?,
  "settings.shortcuts.conflict.description": "{{keybind}} 已分配给 {{titles}}�?,
  "settings.shortcuts.unassigned": "未设�?,
  "settings.shortcuts.pressKeys": "按下按键",
  "settings.shortcuts.search.placeholder": "搜索快捷�?,
  ...
  "settings.providers.title": "提供�?,
  "settings.providers.description": "提供商设置将在此处可配置�?,
  "settings.providers.section.connected": "已连接的提供�?,
  "settings.providers.connected.empty": "没有已连接的提供�?,
  "settings.providers.section.popular": "热门提供�?,
  "settings.providers.tag.environment": "环境",
  "settings.providers.tag.config": "配置",
  "settings.providers.tag.custom": "自定�?,
  "settings.providers.tag.other": "其他",
  "settings.models.title": "模型",
  "settings.models.description": "模型设置将在此处可配置�?,
  "settings.agents.title": "智能�?,
  ...
  "settings.permissions.tool.grep.description": "使用正则表达式搜索文件内�?,
  ...
  "settings.permissions.tool.skill.description": "按名称加载技�?,
  "settings.permissions.tool.lsp.title": "LSP",
  "settings.permissions.tool.lsp.description": "运行语言服务器查�?,
  ...
  "settings.permissions.tool.webfetch.description": "�?URL 获取内容",
  "settings.permissions.tool.websearch.title": "Web Search",
  "settings.permissions.tool.websearch.description": "搜索网页",
  "settings.permissions.tool.codesearch.title": "Code Search",
  "settings.permissions.tool.codesearch.description": "在网上搜索代�?,
  "settings.permissions.tool.external_directory.title": "外部目录",
  "settings.permissions.tool.external_directory.description": "访问项目目录之外的文�?,
  ...
  "workspace.create.failed.title": "创建工作区失�?,
  "workspace.delete.failed.title": "删除工作区失�?,
  "workspace.resetting.title": "正在重置工作�?,
  "workspace.resetting.description": "这可能需要一点时间�?,
  "workspace.reset.failed.title": "重置工作区失�?,
  ...
  "workspace.status.checking": "正在检查未合并的更�?..",
  "workspace.status.error": "无法验证 git 状态�?,
  "workspace.status.clean": "未检测到未合并的更改�?,
  "workspace.status.dirty": "检测到未合并的更改�?,
  "workspace.delete.title": "删除工作�?,
  "workspace.delete.confirm": '删除工作�?"{{name}}"�?,
  "workspace.delete.button": "删除工作�?,
  "workspace.reset.title": "重置工作�?,
  "workspace.reset.confirm": '重置工作�?"{{name}}"�?,
  "workspace.reset.button": "重置工作�?,
  "workspace.reset.archived.none": "不会归档任何活跃会话�?,
  "workspace.reset.archived.one": "将归�?1 个会话�?,
  "workspace.reset.archived.many": "将归�?{{count}} 个会话�?,
