...
export const dict = {
  ...
  "command.sidebar.toggle": "切換側邊�?,
  "command.project.open": "開啟專案",
  "command.provider.connect": "連接提供�?,
  "command.server.switch": "切換伺服�?,
  "command.settings.open": "開啟設定",
  "command.session.previous": "上一個工作階�?,
  "command.session.next": "下一個工作階�?,
  ...
  "command.context.addSelection.description": "加入目前檔案中選取的�?,
  "command.input.focus": "聚焦輸入�?,
  "command.terminal.toggle": "切換終端�?,
  "command.fileTree.toggle": "切換檔案�?,
  "command.review.toggle": "切換審查",
  "command.terminal.new": "新增終端�?,
  "command.terminal.new.description": "建立新的終端機標籤頁",
  "command.steps.toggle": "切換步驟",
  "command.steps.toggle.description": "顯示或隱藏目前訊息的步驟",
  "command.message.previous": "上一則訊�?,
  "command.message.previous.description": "跳到上一則使用者訊�?,
  "command.message.next": "下一則訊�?,
  "command.message.next.description": "跳到下一則使用者訊�?,
  "command.model.choose": "選擇模型",
  "command.model.choose.description": "選擇不同的模�?,
  "command.mcp.toggle": "切換 MCP",
  "command.mcp.toggle.description": "切換 MCP",
  "command.agent.cycle": "循環代理程式",
  "command.agent.cycle.description": "切換到下一個代理程�?,
  "command.agent.cycle.reverse": "反向循環代理程式",
  "command.agent.cycle.reverse.description": "切換到上一個代理程�?,
  "command.model.variant.cycle": "循環思考強�?,
  "command.model.variant.cycle.description": "切換到下一個強度等�?,
  ...
  "command.session.undo.description": "復原上一則訊�?,
  ...
  "command.session.fork": "從訊息分�?,
  "command.session.fork.description": "從先前的訊息建立新工作階�?,
  "command.session.share": "分享工作階段",
  "command.session.share.description": "分享此工作階段並將連結複製到剪貼簿",
  "command.session.unshare": "取消分享工作階段",
  "command.session.unshare.description": "停止分享此工作階�?,
  ...
  "dialog.provider.search.placeholder": "搜尋提供�?,
  "dialog.provider.empty": "找不到提供�?,
  "dialog.provider.group.popular": "熱門",
  "dialog.provider.group.other": "其他",
  "dialog.provider.tag.recommended": "推薦",
  "dialog.provider.anthropic.note": "使用 Claude Pro/Max �?API 金鑰連線",
  "dialog.provider.openai.note": "使用 ChatGPT Pro/Plus �?API 金鑰連線",
  "dialog.provider.copilot.note": "使用 Copilot �?API 金鑰連線",

  "dialog.model.select.title": "選擇模型",
  "dialog.model.search.placeholder": "搜尋模型",
  "dialog.model.empty": "找不到模�?,
  "dialog.model.manage": "管理模型",
  "dialog.model.manage.description": "自訂模型選擇器中顯示的模型�?,

  "dialog.model.unpaid.freeModels.title": "OpenCode 提供的免費模�?,
  "dialog.model.unpaid.addMore.title": "從熱門提供者新增更多模�?,
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並�?OpenCode 中使�?{{provider}} 模型�?,
  "provider.connect.apiKey.label": "{{provider}} API 金鑰",
  "provider.connect.apiKey.placeholder": "API 金鑰",
  "provider.connect.apiKey.required": "API 金鑰為必�?,
  "provider.connect.opencodeZen.line1": "OpenCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式�?,
  "provider.connect.opencodeZen.line2": "只需一�?API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型�?,
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OpenCode 中使�?{{provider}} 模型�?,
  "provider.connect.oauth.code.label": "{{method}} 授權�?,
  "provider.connect.oauth.code.placeholder": "授權�?,
  "provider.connect.oauth.code.required": "授權碼為必填",
  "provider.connect.oauth.code.invalid": "授權碼無�?,
  "provider.connect.oauth.auto.visit.prefix": "造訪 ",
  "provider.connect.oauth.auto.visit.link": "此連結",
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 OpenCode 中使�?{{provider}} 模型�?,
  "provider.connect.oauth.auto.confirmationCode": "確認�?,
  ...
  "provider.custom.description.link": "提供商設定文�?,
  ...
  "provider.custom.error.providerID.required": "提供�?ID 為必�?,
  "provider.custom.error.providerID.format": "請使用小寫字母、數字、連字號或底線",
  "provider.custom.error.providerID.exists": "該提供商 ID 已存�?,
  "provider.custom.error.name.required": "顯示名稱為必�?,
  "provider.custom.error.baseURL.required": "基礎 URL 為必�?,
  "provider.custom.error.baseURL.format": "必須�?http:// �?https:// 開頭",
  ...
  "model.tooltip.reasoning.none": "不支援推�?,
  ...
  "prompt.placeholder.normal": '隨便問點什�?.. "{{example}}"',
  "prompt.placeholder.summarizeComments": "摘要評論�?,
  "prompt.placeholder.summarizeComment": "摘要這則評論�?,
  "prompt.mode.shell": "Shell",
  "prompt.mode.shell.exit": "�?esc 退�?,

  "prompt.example.1": "修復程式碼庫中的一�?TODO",
  "prompt.example.2": "這個專案的技術堆疊是什�?",
  "prompt.example.3": "修復失敗的測�?,
  "prompt.example.4": "解釋驗證是如何運作的",
  "prompt.example.5": "尋找並修復安全漏�?,
  "prompt.example.6": "為使用者服務新增單元測�?,
  "prompt.example.7": "重構這個函式，讓它更易讀",
  "prompt.example.8": "這個錯誤是什麼意�?",
  "prompt.example.9": "幫我偵錯這個問�?,
  "prompt.example.10": "產生 API 文件",
  "prompt.example.11": "最佳化資料庫查�?,
  "prompt.example.12": "新增輸入驗證",
  "prompt.example.13": "建立一個新的元件用�?..",
  "prompt.example.14": "我該如何部署這個專�?",
  "prompt.example.15": "審查我的程式碼並給出最佳實務建�?,
  "prompt.example.16": "為這個函式新增錯誤處�?,
  "prompt.example.17": "解釋這個正規表示式",
  "prompt.example.18": "把它轉換�?TypeScript",
  "prompt.example.19": "在整個程式碼庫中新增日誌",
  "prompt.example.20": "哪些相依性已經過�?",
  "prompt.example.21": "幫我寫一個遷移腳�?,
  "prompt.example.22": "為這個端點實作快�?,
  "prompt.example.23": "給這個清單新增分�?,
  "prompt.example.24": "建立一�?CLI 命令用於...",
  "prompt.example.25": "這裡的環境變數是怎麼運作�?",

  "prompt.popover.emptyResults": "沒有符合的結�?,
  "prompt.popover.emptyCommands": "沒有符合的命�?,
  "prompt.dropzone.label": "將圖片或 PDF 拖到這裡",
  "prompt.dropzone.file.label": "拖放�?@提及檔案",
  "prompt.slash.badge.custom": "自訂",
  "prompt.slash.badge.skill": "技�?,
  "prompt.slash.badge.mcp": "mcp",
  "prompt.context.active": "作用�?,
  "prompt.context.includeActiveFile": "包含作用中檔�?,
  "prompt.context.removeActiveFile": "從上下文移除目前檔案",
  "prompt.context.removeFile": "從上下文移除檔案",
  "prompt.action.attachFile": "附加檔案",
  "prompt.attachment.remove": "移除附件",
  "prompt.action.send": "傳�?,
  "prompt.action.stop": "停止",

  "prompt.toast.pasteUnsupported.title": "不支援的貼上",
  "prompt.toast.pasteUnsupported.description": "這裡只能貼上圖片�?PDF 檔案�?,
  "prompt.toast.modelAgentRequired.title": "請選擇代理程式和模型",
  "prompt.toast.modelAgentRequired.description": "傳送提示前請先選擇代理程式和模型�?,
  "prompt.toast.worktreeCreateFailed.title": "建立工作樹失�?,
  "prompt.toast.sessionCreateFailed.title": "建立工作階段失敗",
  "prompt.toast.shellSendFailed.title": "傳�?shell 命令失敗",
  "prompt.toast.commandSendFailed.title": "傳送命令失�?,
  "prompt.toast.promptSendFailed.title": "傳送提示失�?,
  "prompt.toast.promptSendFailed.description": "無法取得工作階段",

  "dialog.mcp.title": "MCP",
  "dialog.mcp.description": "已啟�?{{enabled}} / {{total}}",
  "dialog.mcp.empty": "未設�?MCP",

  "dialog.lsp.empty": "已從檔案類型自動偵測�?LSPs",
  "dialog.plugins.empty": "�?opencode.json 中設定的外掛程式",

  "mcp.status.connected": "已連線",
  "mcp.status.failed": "失敗",
  "mcp.status.needs_auth": "需要授�?,
  "mcp.status.disabled": "已停�?,

  "dialog.fork.empty": "沒有可用於分支的訊息",

  "dialog.directory.search.placeholder": "搜尋資料�?,
  "dialog.directory.empty": "找不到資料夾",

  "dialog.server.title": "伺服�?,
  "dialog.server.description": "切換此應用程式連線�?OpenCode 伺服器�?,
  "dialog.server.search.placeholder": "搜尋伺服�?,
  "dialog.server.empty": "暫無伺服�?,
  "dialog.server.add.title": "新增伺服�?,
  "dialog.server.add.url": "伺服�?URL",
  "dialog.server.add.placeholder": "http://localhost:4096",
  "dialog.server.add.error": "無法連線到伺服器",
  "dialog.server.add.checking": "檢查�?..",
  "dialog.server.add.button": "新增伺服�?,
  "dialog.server.default.title": "預設伺服�?,
  ...
  "dialog.server.action.remove": "移除伺服�?,
  ...
  "dialog.project.edit.icon.hint": "點擊或拖曳圖�?,
  "dialog.project.edit.icon.recommended": "建議�?28x128px",
  ...
  "toast.permissions.autoaccept.off.title": "已停止自動接受編�?,
  "toast.permissions.autoaccept.off.description": "編輯和寫入權限將需要手動批�?,

  "toast.model.none.title": "未選擇模�?,
  "toast.model.none.description": "請先連線提供者以總結此工作階�?,
  ...
  "toast.session.share.success.title": "工作階段已分�?,
  "toast.session.share.success.description": "分享連結已複製到剪貼�?,
  "toast.session.share.failed.title": "分享工作階段失敗",
  "toast.session.share.failed.description": "分享工作階段時發生錯�?,

  "toast.session.unshare.success.title": "已取消分享工作階�?,
  "toast.session.unshare.success.description": "工作階段已成功取消分�?,
  "toast.session.unshare.failed.title": "取消分享失敗",
  "toast.session.unshare.failed.description": "取消分享工作階段時發生錯�?,

  "toast.session.listFailed.title": "無法載入 {{project}} 的工作階�?,

  "toast.update.title": "有可用更�?,
  "toast.update.description": "OpenCode 有新版本 ({{version}}) 可安裝�?,
  "toast.update.action.installRestart": "安裝並重新啟�?,
  "toast.update.action.notYet": "稍後",

  "error.page.title": "出了點問�?,
  "error.page.description": "載入應用程式時發生錯誤�?,
  "error.page.details.label": "錯誤詳情",
  "error.page.action.restart": "重新啟動",
  "error.page.action.checking": "檢查�?..",
  ...
  "error.dev.rootNotFound": "找不到根元素。你是不是忘了把它新增到 index.html? 或�?id 屬性拼錯了?",

  "error.globalSync.connectFailed": "無法連線到伺服器。是否有伺服器正�?`{{url}}` 執行?",
  "directory.error.invalidUrl": "URL 中的目錄無效�?,

  "error.chain.unknown": "未知錯誤",
  "error.chain.causedBy": "原因:",
  "error.chain.apiError": "API 錯誤",
  "error.chain.status": "狀�? {{status}}",
  "error.chain.retryable": "可重�? {{retryable}}",
  "error.chain.responseBody": "回應內容:\n{{body}}",
  "error.chain.didYouMean": "你是不是想輸�? {{suggestions}}",
  "error.chain.modelNotFound": "找不到模�? {{provider}}/{{model}}",
  "error.chain.checkConfig": "請檢查你的設�?(opencode.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服�?"{{name}}" 啟動失敗。注�? OpenCode 暫不支援 MCP 認證�?,
  "error.chain.providerAuthFailed": "提供者認證失�?({{provider}}): {{message}}",
  "error.chain.providerInitFailed": '無法初始化提供�?"{{provider}}"。請檢查憑證和設定�?,
  "error.chain.configJsonInvalid": "設定�?{{path}} 不是有效�?JSON(C)",
  "error.chain.configJsonInvalidWithMessage": "設定�?{{path}} 不是有效�?JSON(C): {{message}}",
  "error.chain.configDirectoryTypo":
    '{{path}} 中的目錄 "{{dir}}" 無效。請將目錄重新命名為 "{{suggestion}}" 或移除它。這是一個常見拼寫錯誤�?,
  "error.chain.configFrontmatterError": "無法解析 {{path}} 中的 frontmatter:\n{{message}}",
  "error.chain.configInvalid": "設定�?{{path}} 無效",
  "error.chain.configInvalidWithMessage": "設定�?{{path}} 無效: {{message}}",

  "notification.permission.title": "需要權�?,
  "notification.permission.description": "{{sessionTitle}}（{{projectName}}）需要權�?,
  "notification.question.title": "問題",
  "notification.question.description": "{{sessionTitle}}（{{projectName}}）有一個問�?,
  "notification.action.goToSession": "前往工作階段",

  "notification.session.responseReady.title": "回覆已就�?,
  "notification.session.error.title": "工作階段錯誤",
  "notification.session.error.fallbackDescription": "發生錯誤",

  "home.recentProjects": "最近專�?,
  "home.empty.title": "沒有最近專�?,
  "home.empty.description": "透過開啟本地專案開始使用",

  "session.tab.session": "工作階段",
  "session.tab.review": "審查",
  "session.tab.context": "上下�?,
  "session.panel.reviewAndFiles": "審查與檔�?,
  "session.review.filesChanged": "{{count}} 個檔案變�?,
  "session.review.change.one": "變更",
  "session.review.change.other": "變更",
  "session.review.loadingChanges": "正在載入變更...",
  "session.review.empty": "此工作階段暫無變�?,
  "session.review.noChanges": "沒有變更",
  "session.files.selectToOpen": "選取要開啟的檔案",
  "session.files.all": "所有檔�?,
  "session.files.binaryContent": "二進位檔案（無法顯示內容）",
  "session.messages.renderEarlier": "顯示更早的訊�?,
  "session.messages.loadingEarlier": "正在載入更早的訊�?..",
  "session.messages.loadEarlier": "載入更早的訊�?,
  "session.messages.loading": "正在載入訊息...",

  "session.messages.jumpToLatest": "跳到最�?,
  "session.context.addToContext": "�?{{selection}} 新增到上下文",

  "session.new.worktree.main": "主分�?,
  "session.new.worktree.mainWithBranch": "主分�?({{branch}})",
  "session.new.worktree.create": "建立新的 worktree",
  "session.new.lastModified": "最後修�?,

  "session.header.search.placeholder": "搜尋 {{project}}",
  "session.header.searchFiles": "搜尋檔案",

  "status.popover.trigger": "狀�?,
  "status.popover.ariaLabel": "伺服器設�?,
  "status.popover.tab.servers": "伺服�?,
  "status.popover.tab.mcp": "MCP",
  "status.popover.tab.lsp": "LSP",
  "status.popover.tab.plugins": "外掛程式",
  "status.popover.action.manageServers": "管理伺服�?,

  "session.share.popover.title": "發佈到網�?,
  ...
  "sidebar.nav.projectsAndSessions": "專案與工作階�?,
  "sidebar.settings": "設定",
  "sidebar.help": "說明",
  ...
  "sidebar.gettingStarted.line2": "連線任意提供者即可使用更多模型，�?Claude、GPT、Gemini 等�?,
  "sidebar.project.recentSessions": "最近工作階�?,
  "sidebar.project.viewAllSessions": "查看全部工作階段",

  "app.name.desktop": "OpenCode Desktop",
  "settings.section.desktop": "桌面",
  "settings.section.server": "伺服�?,
  ...
  "settings.general.row.releaseNotes.description": "更新後顯示「新功能」彈出視�?,

  "settings.updates.row.startup.title": "啟動時檢查更�?,
  "settings.updates.row.startup.description": "�?OpenCode 啟動時自動檢查更�?,
  ...
  "settings.updates.action.checking": "檢查�?..",
  ...
  "settings.general.sounds.errors.description": "發生錯誤時播放聲�?,

  "settings.shortcuts.title": "鍵盤快速鍵",
  "settings.shortcuts.reset.button": "重設為預設�?,
  "settings.shortcuts.reset.toast.title": "快速鍵已重�?,
  ...
  "settings.shortcuts.unassigned": "未設�?,
  ...
  "settings.shortcuts.group.modelAndAgent": "模型與代理程�?,
  "settings.shortcuts.group.terminal": "終端�?,
  ...
  "settings.permissions.tool.read.title": "讀�?,
  ...
  "settings.permissions.tool.grep.description": "使用正規表示式搜尋檔案內�?,
  ...
  "settings.permissions.tool.task.description": "啟動子代理程�?,
  "settings.permissions.tool.skill.title": "Skill",
  "settings.permissions.tool.skill.description": "按名稱載入技�?,
  "settings.permissions.tool.lsp.title": "LSP",
  "settings.permissions.tool.lsp.description": "執行語言伺服器查�?,
  "settings.permissions.tool.todoread.title": "讀取待�?,
  "settings.permissions.tool.todoread.description": "讀取待辦清�?,
  "settings.permissions.tool.todowrite.title": "更新待辦",
  "settings.permissions.tool.todowrite.description": "更新待辦清單",
  "settings.permissions.tool.webfetch.title": "Web Fetch",
  "settings.permissions.tool.webfetch.description": "�?URL 取得內容",
  "settings.permissions.tool.websearch.title": "Web Search",
  "settings.permissions.tool.websearch.description": "搜尋網頁",
  "settings.permissions.tool.codesearch.title": "Code Search",
  "settings.permissions.tool.codesearch.description": "在網路上搜尋程式�?,
  "settings.permissions.tool.external_directory.title": "外部目錄",
  "settings.permissions.tool.external_directory.description": "存取專案目錄之外的檔�?,
  "settings.permissions.tool.doom_loop.title": "Doom Loop",
  "settings.permissions.tool.doom_loop.description": "偵測具有相同輸入的重複工具呼�?,
  ...
  "workspace.reset.success.title": "工作區已重�?,
  "workspace.reset.success.description": "工作區已與預設分支保持一致�?,
  "workspace.error.stillPreparing": "工作區仍在準備�?,
  ...
  "workspace.reset.archived.one": "將封�?1 個工作階段�?,
  "workspace.reset.archived.many": "將封�?{{count}} 個工作階段�?,
