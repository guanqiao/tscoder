...
export const dict = {
  ...
  "zen.problem.subtitle": "我们正在为所有人修复此问题，而不仅仅�?OpenCode 用户�?,
  "zen.problem.item1": "测试选定的模型并咨询其团�?,
  "zen.problem.item2": "与提供商合作以确保正确交�?,
  "zen.problem.item3": "对我们推荐的所有模�?提供商组合进行基准测�?,
  "zen.how.title": "Zen 如何运作",
  "zen.how.body": "虽然我们建议您将 Zen �?OpenCode 一起使用，但您可以�?Zen 与任何代理一起使用�?,
  "zen.how.step1.title": "注册并添�?20 美元余额",
  "zen.how.step1.beforeLink": "遵循",
  "zen.how.step1.link": "设置说明",
  "zen.how.step2.title": "使用 Zen 并提供透明的定�?,
  "zen.how.step2.link": "按请求付�?,
  "zen.how.step2.afterLink": "零加�?,
  "zen.how.step3.title": "自动充�?,
  "zen.how.step3.body": "当您的余额达�?5 美元时，我们会自动添�?20 美元",
  "zen.privacy.title": "您的隐私对我们很重要",
  "zen.privacy.beforeExceptions": "所�?Zen 模型均在美国托管。提供商遵循零保留政策，不会将您的数据用于模型训练，并且",
  ...
  "workspace.home.billing.loading": "加载�?..",
  ...
  "workspace.newUser.feature.quality.title": "最高品�?,
  "workspace.newUser.feature.quality.body": "访问模型配置为最佳性能 - 无需降级或路由到更便宜的提供商�?,
  "workspace.newUser.feature.lockin.title": "无锁�?,
  "workspace.newUser.feature.lockin.body":
    "�?Zen 与任何编码代理结合使用，并在需要时继续将其他提供程序与 opencode 结合使用�?,
  ...
  "workspace.newUser.step.models.before": "启动 opencode 并运�?,
  ...
  "workspace.providers.subtitle": "�?AI 提供商处配置您自己的 API 密钥�?,
  ...
  "workspace.cost.allModels": "所有模�?,
  "workspace.cost.allKeys": "所有密�?,
  ...
  "workspace.keys.subtitle": "管理您的 API 密钥以访�?opencode 服务�?,
  ...
  "workspace.keys.table.createdBy": "创建�?,
  "workspace.keys.table.lastUsed": "最后使�?,
  ...
  "workspace.billing.loading": "加载�?..",
  "workspace.billing.addAction": "添加",
  "workspace.billing.addBalance": "添加余额",
  "workspace.billing.linkedToStripe": "已绑�?Stripe",
  ...
  "workspace.monthlyLimit.setting": "设置�?..",
  ...
  "workspace.monthlyLimit.currentUsage.beforeAmount": "的使用量�?$",
  "workspace.reload.title": "自动充�?,
  ...
  "workspace.reload.enabled.state": "已启�?,
  "workspace.reload.enabled.middle": "我们将自动充�?,
  "workspace.reload.processingFee": "手续�?,
  "workspace.reload.enabled.after": "当余额达�?,
  "workspace.reload.edit": "编辑",
  "workspace.reload.enable": "启用",
  "workspace.reload.enableAutoReload": "启用自动充�?,
  "workspace.reload.reloadAmount": "充�?$",
  "workspace.reload.whenBalanceReaches": "当余额达�?$",
  ...
  "workspace.black.time.fewSeconds": "几秒�?,
  ...
  "workspace.black.subscription.weeklyUsage": "每周使用�?,
  "workspace.black.subscription.resetsIn": "重置�?,
  "workspace.black.subscription.useBalance": "达到使用限额后使用您的可用余�?,
  "workspace.black.waitlist.title": "候补名单",
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} �?OpenCode Black 方案候补名单�?,
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} �?OpenCode Black 方案�?,
  "workspace.black.waitlist.leave": "离开候补名单",
  "workspace.black.waitlist.leaving": "离开...",
  "workspace.black.waitlist.left": "已退�?,
  "workspace.black.waitlist.enroll": "加入",
  "workspace.black.waitlist.enrolling": "加入�?..",
  "workspace.black.waitlist.enrolled": "已加�?,
