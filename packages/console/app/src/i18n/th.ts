...
export const dict = {
  ...
  "zen.pricing.body": "ใช้ร่วมกับตัวแทนใด�?กำหนดวงเงินการใช้จ่ายรายเดือน ยกเลิกได้ตลอดเวล�?,
  "zen.problem.title": "Zen กำลังแก้ปัญหาอะไรอยู�?",
  "zen.problem.body":
    "มีหลายรุ่นให้เลือก แต่มีเพียงไม่กี่รุ่นเท่านั้นที่ทำงานได้ดีกับเอเจนต์การเขียนโค้ด ผู้ให้บริการส่วนใหญ่กำหนดค่าให้แตกต่างออกไปด้วยผลลัพธ์ที่แตกต่างกั�?,
  "zen.problem.subtitle": "เรากำลังแก้ไขปัญหานี้สำหรับทุกค�?ไม่ใช่แค่ผู้ใช�?OpenCode เท่านั้�?,
  "zen.problem.item1": "ทดสอบโมเดลที่เลือกและปรึกษาทีมงา�?,
  "zen.problem.item2": "ทำงานร่วมกับผู้ให้บริการเพื่อให้แน่ใจว่ามีการจัดส่งอย่างถูกต้อง",
  "zen.problem.item3": "การเปรียบเทียบชุดค่าผสมของผู้ให้บริการโมเดลทั้งหมดที่เราแนะน�?,
  "zen.how.title": "Zen ทำงานอย่างไร",
  "zen.how.body": "แม้ว่าเราจะแนะนำให้คุณใช้ Zen กั�?OpenCode แต่คุณสามารถใช�?Zen กับตัวแทนใดก็ได้",
  "zen.how.step1.title": "ลงทะเบียนและเพิ่มยอดคงเหลือ $20",
  "zen.how.step1.beforeLink": "ปฏิบัติตาม",
  "zen.how.step1.link": "คำแนะนำในการตั้งค่�?,
  "zen.how.step2.title": "ใช�?Zen ด้วยการกำหนดราคาที่โปร่งใส",
  "zen.how.step2.link": "จ่ายตามคำข�?,
  ...
  "zen.privacy.beforeExceptions":
    "โมเดล Zen ทั้งหมดโฮสต์ในสหรัฐอเมริก�?ผู้ให้บริการปฏิบัติตามนโยบายการเก็บรักษาเป็นศูนย์และไม่ใช้ข้อมูลของคุณสำหรับการฝึกโมเดลด้วย",
  "zen.privacy.exceptionsLink": "ข้อยกเว้นต่อไปนี�?,
  ...
  "workspace.newUser.feature.tested.title": "รุ่นที่ผ่านการทดสอบและตรวจสอบแล้�?,
  ...
  "workspace.newUser.feature.quality.body":
    "โมเดลการเข้าถึงที่กำหนดค่าไว้เพื่อประสิทธิภาพสูงสุ�?- ไม่ต้องดาวน์เกรดหรือกำหนดเส้นทางไปยังผู้ให้บริการที่ถูกกว่�?,
  "workspace.newUser.feature.lockin.title": "ไม่มีการล็อคอิ�?,
  "workspace.newUser.feature.lockin.body":
    "ใช�?Zen กับตัวแทนการเขียนโค้ด และใช้ผู้ให้บริการรายอื่นต่อไปด้วย opencode ทุกครั้งที่คุณต้องกา�?,
  ...
  "workspace.newUser.step.pasteKey": "วางคีย�?API ของคุณ",
  "workspace.newUser.step.models.before": "เริ่มต้�?opencode และเรียกใช�?,
  "workspace.newUser.step.models.after": "เพื่อเลือกรุ่น",
  "workspace.models.title": "โมเดล",
  "workspace.models.subtitle.beforeLink": "จัดการโมเดลที่สมาชิกพื้นที่ทำงานสามารถเข้าถึงได�?,
  "workspace.models.table.model": "แบบอย่าง",
  "workspace.models.table.enabled": "เปิดใช้งานแล้�?,
  "workspace.providers.title": "นำกุญแจมาเอง",
  "workspace.providers.subtitle": "กำหนดค่าคีย์ API ของคุณเองจากผู้ให้บริกา�?AI",
  ...
  "workspace.providers.saving": "ประหยั�?..",
  ...
  "workspace.usage.table.output": "เอาท์พุ�?,
  "workspace.usage.table.cost": "ค่าใช้จ่าย",
  "workspace.usage.breakdown.input": "ป้อนข้อมูล",
  "workspace.usage.breakdown.cacheRead": "แคชอ่า�?,
  "workspace.usage.breakdown.cacheWrite": "แคชเขียน",
  "workspace.usage.breakdown.output": "เอาท์พุ�?,
  "workspace.usage.breakdown.reasoning": "การใช้เหตุผ�?,
  "workspace.usage.subscription": "สมัครสมาชิ�?(${{amount}})",
  "workspace.cost.title": "ค่าใช้จ่าย",
  "workspace.cost.subtitle": "ต้นทุนการใช้งานแยกตามรุ่�?,
  "workspace.cost.allModels": "ทุกรุ่�?,
  ...
  "workspace.keys.create": "สร้างคีย�?API",
  "workspace.keys.placeholder": "ป้อนชื่อคีย์",
  "workspace.keys.empty": "สร้างคีย�?opencode เกตเวย�?API",
  "workspace.keys.table.name": "ชื่อ",
  "workspace.keys.table.key": "สำคั�?,
  ...
  "workspace.members.invited": "เชิ�?,
  "workspace.members.edit": "แก้ไ�?,
  "workspace.members.delete": "ลบ",
  "workspace.members.saving": "ประหยั�?..",
  ...
  "workspace.members.role.admin": "ผู้ดูแลระบ�?,
  ...
  "workspace.members.role.memberDescription": "สามารถสร้างคีย�?API สำหรับตัวเองได้เท่านั้�?,
  ...
  "workspace.monthlyLimit.subtitle": "กำหนดขีดจำกัดการใช้งานรายเดือนสำหรับบัญชีของคุ�?,
  "workspace.monthlyLimit.placeholder": "50",
  "workspace.monthlyLimit.setting": "กำลังตั้งค่า...",
  "workspace.monthlyLimit.set": "ชุ�?,
  ...
  "workspace.reload.disabled.state": "พิกา�?,
  "workspace.reload.disabled.after": "เปิดใช้งานเพื่อโหลดซ้ำอัตโนมัติเมื่อยอดเงินคงเหลือต่�?,
  "workspace.reload.enabled.before": "รีโหลดอัตโนมัติคือ",
  "workspace.reload.enabled.state": "เปิดใช้งา�?,
  "workspace.reload.enabled.middle": "เราจะโหลดซ้�?,
  "workspace.reload.processingFee": "ค่าธรรมเนียมการดำเนินการ",
  "workspace.reload.enabled.after": "เมื่อถึงจุดสมดุ�?,
  ...
  "workspace.reload.saving": "ประหยั�?..",
  ...
  "workspace.payments.subtitle": "ธุรกรรมการชำระเงินล่าสุ�?,
  "workspace.payments.table.date": "วันที่",
  "workspace.payments.table.paymentId": "รหัสการชำระเงิ�?,
  "workspace.payments.table.amount": "จำนว�?,
  "workspace.payments.table.receipt": "ใบเสร็จ",
  "workspace.payments.type.credit": "เครดิ�?,
  "workspace.payments.type.subscription": "สมัครสมาชิ�?,
  ...
  "workspace.black.subscription.title": "สมัครสมาชิ�?,
  "workspace.black.subscription.message": "คุณสมัครรับข้อมู�?OpenCode Black ในราคา ${{plan}} ต่อเดือน",
  ...
  "workspace.black.subscription.resetsIn": "รีเซ็ตเข้�?,
  ...
  "workspace.black.waitlist.joined": "คุณอยู่ในรายชื่อรอสำหรับแผ�?${{plan}} ต่อเดือน OpenCode Black",
  ...
  "workspace.black.waitlist.enrollNote":
    "เมื่อคุณคลิกลงทะเบียน การสมัครของคุณจะเริ่มต้นทันทีและบัตรของคุณจะถูกเรียกเก็บเงิ�?,
} satisfies Dict
