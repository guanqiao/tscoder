...
export const dict = {
  ...
  "workspace.home.billing.loading": "読み込み�?..",
  "workspace.home.billing.enable": "課金を有効にする",
  "workspace.home.billing.currentBalance": "現在の残�?,
  "workspace.newUser.feature.tested.title": "テストおよび検証されたモデル",
  "workspace.newUser.feature.tested.body":
    "最高のパフォーマンスを保証するために、コーディン�?エージェントに特化したモデルのベンチマークとテストを行いました�?,
  ...
  "workspace.newUser.feature.lockin.title": "ロックインな�?,
  "workspace.newUser.feature.lockin.body":
    "任意のコーディン�?エージェント�?Zen を使用し、必要に応じていつで�?opencode を備えた他のプロバイダーを使用し続けます�?,
  "workspace.newUser.copyApiKey": "API キーをコピーしま�?,
  ...
  "workspace.providers.table.provider": "プロバイダ�?,
  ...
  "workspace.usage.table.model": "モデ�?,
  ...
  "workspace.billing.currentBalance": "現在の残�?,
  "workspace.billing.add": "$を追�?,
  "workspace.billing.enterAmount": "金額を入力してくださ�?,
  "workspace.billing.loading": "読み込み�?..",
  "workspace.billing.addAction": "追加",
  "workspace.billing.addBalance": "残高を追�?,
  "workspace.billing.linkedToStripe": "ストライプにリン�?,
  "workspace.billing.manage": "管理",
  "workspace.billing.enable": "課金を有効にする",
  "workspace.monthlyLimit.title": "月間限度�?,
  "workspace.monthlyLimit.subtitle": "アカウントの月間使用制限を設定します�?,
  "workspace.monthlyLimit.placeholder": "50",
  "workspace.monthlyLimit.setting": "設定...",
  "workspace.monthlyLimit.set": "セッ�?,
  "workspace.monthlyLimit.edit": "編集制限",
  "workspace.monthlyLimit.noLimit": "使用制限は設定されていません�?,
  "workspace.monthlyLimit.currentUsage.beforeMonth": "現在の使用状�?,
  "workspace.monthlyLimit.currentUsage.beforeAmount": "�?です",
  "workspace.reload.title": "オートリロー�?,
  ...
  "workspace.reload.enabled.middle": "リロードしま�?,
  "workspace.reload.processingFee": "手数�?,
  "workspace.reload.enabled.after": "残高が達したとき",
  "workspace.reload.edit": "編集",
  "workspace.reload.enable": "有効にす�?,
  "workspace.reload.enableAutoReload": "自動リロードを有効にする",
  "workspace.reload.reloadAmount": "$をリロー�?,
  "workspace.reload.whenBalanceReaches": "残高�?に達する�?,
  "workspace.reload.saving": "保存�?..",
  "workspace.reload.save": "保存",
  "workspace.reload.failedAt": "リロードに失敗しまし�?,
  ...
  "workspace.payments.title": "支払い履�?,
  "workspace.payments.subtitle": "最近の支払い取引�?,
  "workspace.payments.table.date": "日付",
  "workspace.payments.table.paymentId": "支払いID",
  "workspace.payments.table.amount": "�?,
  "workspace.payments.table.receipt": "レシート",
  "workspace.payments.type.credit": "クレジッ�?,
  "workspace.payments.type.subscription": "サブスクリプショ�?,
  "workspace.payments.view": "ビュ�?,
  "workspace.black.loading": "読み込み�?..",
  ...
  "workspace.black.subscription.title": "サブスクリプショ�?,
  "workspace.black.subscription.message": "あなたは、OpenCode Black を月�?${{plan}} で購読しています�?,
  "workspace.black.subscription.manage": "サブスクリプションの管理",
  "workspace.black.subscription.rollingUsage": "5時間利用",
  "workspace.black.subscription.weeklyUsage": "毎週の使用�?,
  "workspace.black.subscription.resetsIn": "でリセットします",
  "workspace.black.subscription.useBalance": "利用限度額に達したら利用可能な残高を使い切る",
  "workspace.black.waitlist.title": "順番待ちリス�?,
  "workspace.black.waitlist.joined":
    "あなたは、月�?${{plan}} OpenCode ブラック プランの待機リストに登録されています�?,
  "workspace.black.waitlist.ready": "月額 ${{plan}} �?OpenCode ブラック プランに登録する準備ができました�?,
  "workspace.black.waitlist.leave": "順番待ちリストを残す",
  "workspace.black.waitlist.leaving": "出発�?..",
  "workspace.black.waitlist.left": "�?,
  "workspace.black.waitlist.enroll": "登録する",
  "workspace.black.waitlist.enrolling": "登録�?..",
