...
export const dict = {
  ...
  "zen.problem.subtitle": "我們正在為所有人修復此問題，而不僅僅�?OpenCode 用戶�?,
  "zen.problem.item1": "測試選定的模型並諮詢其團�?,
  "zen.problem.item2": "與提供商合作以確保正確交�?,
  "zen.problem.item3": "對我們推薦的所有模�?提供商組合進行基準測試",
  "zen.how.title": "Zen 如何運作",
  "zen.how.body": "雖然我們建議您�?Zen �?OpenCode 一起使用，但您可以�?Zen 與任何代理一起使用�?,
  "zen.how.step1.title": "註冊並添�?20 美元餘額",
  "zen.how.step1.beforeLink": "遵循",
  "zen.how.step1.link": "設置說明",
  "zen.how.step2.title": "使用 Zen 並提供透明的定�?,
  "zen.how.step2.link": "按請求付�?,
  "zen.how.step2.afterLink": "零加�?,
  "zen.how.step3.title": "自動充�?,
  "zen.how.step3.body": "當您的餘額達�?5 美元時，我們會自動添加 20 美元",
  "zen.privacy.title": "您的隱私對我們很重要",
  "zen.privacy.beforeExceptions": "所�?Zen 模型均在美國託管。提供商遵循零保留政策，不會將您的數據用於模型訓練，並且",
  ...
  "workspace.home.billing.loading": "載入�?..",
  ...
  "workspace.newUser.feature.lockin.title": "無鎖�?,
  "workspace.newUser.feature.lockin.body":
    "�?Zen 與任何編碼代理結合使用，並在需要時繼續將其他提供程序與 opencode 結合使用�?,
  ...
  "workspace.newUser.step.login.after": "並選�?opencode",
  "workspace.newUser.step.pasteKey": "粘貼您的 API 密鑰",
  "workspace.newUser.step.models.before": "啟動 opencode 並運�?,
  ...
  "workspace.providers.subtitle": "�?AI 提供商處配置您自己的 API 密鑰�?,
  ...
  "workspace.usage.empty": "進行第一�?API 調用即可開始�?,
  ...
  "workspace.usage.breakdown.cacheRead": "緩存讀�?,
  ...
  "workspace.keys.subtitle": "管理您的 API 密鑰以訪�?opencode 服務�?,
  ...
  "workspace.keys.table.createdBy": "創建�?,
  "workspace.keys.table.lastUsed": "最後使�?,
  ...
  "workspace.members.role.memberDescription": "只能為自己生�?API 密鑰",
  ...
  "workspace.billing.contactUs": "聯繫我�?,
  ...
  "workspace.reload.enabled.state": "已啟�?,
  "workspace.reload.enabled.middle": "我們將自動儲�?,
  "workspace.reload.processingFee": "手續�?,
  "workspace.reload.enabled.after": "當餘額達�?,
  "workspace.reload.edit": "編輯",
  "workspace.reload.enable": "啟用",
  "workspace.reload.enableAutoReload": "啟用自動儲�?,
  "workspace.reload.reloadAmount": "儲�?$",
  "workspace.reload.whenBalanceReaches": "當餘額達�?$",
  ...
  "workspace.black.time.fewSeconds": "幾秒�?,
  ...
  "workspace.black.subscription.useBalance": "達到使用限額後使用您的可用餘�?,
  "workspace.black.waitlist.title": "候補名單",
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} �?OpenCode Black 方案候補名單�?,
  "workspace.black.waitlist.ready": "我們已準備好將您加入每�?${{plan}} �?OpenCode Black 方案�?,
